    ...
    // This component can be imported into your ContactUS component
    // Replace the existing map placeholder with: <LaundryMap />
    ...
    const laundryCoordinates = [5.965437, 80.394401]; // Approximate coordinates for Midigama area
    ...
    useEffect(() => {
        ...
        if (!document.querySelector('link[href*="leaflet"]')) {
            ...
            leafletCSS.integrity = 'sha512-puBpdR0798OZvTTbP4A8Ix/l+A4dHDD0DGqYW6RQ+9jxkRFclaxxQb/SJAWZfWAkuyeQUytO7+7N4QKrDh+drA==';
        ...
        if (!window.L) {
            ...
            leafletJS.integrity = 'sha512-Ow2rOlQgmNr6kJvFoaYSm9U0t1/zv8QGm5v3Y5W/vbwOHJjrY8OmSbR3iO7r9qGPP7p6Uw+l5KjKUk1OYRXaug==';
        ...
        if (mapRef.current && window.L && !mapInstanceRef.current) {
            ...
            // Create custom icon for the laundry
            ...
            // Add a circle to show service area (5km radius)
            window.L.circle(laundryCoordinates, {
            color: '#4F46E5',
            fillColor: '#4F46E5',
            fillOpacity: 0.1,
            radius: 5000, // 5km radius for free pickup/delivery
            stroke: true,
            weight: 2,
            dashArray: '5, 5'
            }).addTo(map).bindPopup(`
    ...
    return (
        ...
        <div className="mb-6">
            ...
            Located right next to the famous Midigama surf break - perfect for surfers and locals!
            </p>
        </div>
        ...
        <div className="relative">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                    ...
                    <span className="text-sm text-indigo-600 font-medium">Express service available!</span>
                </p>
                </div>
            </div>
            </div>
            ...
            <p className="text-sm text-gray-700 text-center">
                <span className="font-semibold text-indigo-700">🚛 Free Pickup & Delivery</span> within 5km radius • 
                <span className="font-semibold text-purple-700"> Perfect for surfers staying nearby!</span>
            </p>
            </div>
        </div>
        </div>
