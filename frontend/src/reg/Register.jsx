    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 p-4">
      ...
      <div className="relative bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl shadow-2xl flex w-full max-w-4xl overflow-hidden">
        ...
        <div className="hidden md:flex flex-col justify-center items-center bg-gradient-to-br from-white/20 to-white/5 backdrop-blur-sm p-12 w-1/2 relative">
          <div className="absolute inset-0 bg-gradient-to-br from-purple-400/10 to-blue-600/10"></div>
          <div className="relative z-10 text-center">
            <div className="mb-8 relative">
              ...
              <div className="absolute -top-2 -right-2 w-4 h-4 bg-gradient-to-r from-purple-400 to-pink-600 rounded-full animate-ping"></div>
              <div className="absolute -bottom-2 -left-2 w-3 h-3 bg-gradient-to-r from-blue-400 to-purple-600 rounded-full animate-pulse"></div>
            </div>
            <h2 className="text-3xl font-bold bg-gradient-to-r from-white to-purple-100 bg-clip-text text-transparent mb-4">
              Join Our Family!
            </h2>
            <p className="text-white/80 text-lg leading-relaxed">
              Create an account to enjoy our premium laundry services and seamless experience.
            </p>
        ...
        <div className="flex-1 p-12 flex flex-col justify-center relative">
          ...
          <div className="relative z-10">
            <div className="text-center mb-8">
              <h2 className="text-4xl font-bold bg-gradient-to-r from-white via-purple-100 to-blue-100 bg-clip-text text-transparent mb-2">
                Create Account
              </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="relative group">
                <input
                  ...
                  onChange={handleChange}
                  className="w-full p-4 bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl text-white placeholder-white/60 focus:ring-2 focus:ring-purple-400/50 focus:border-purple-400/50 outline-none transition-all duration-300 group-hover:border-white/30 pr-12"
                  required
                  disabled={loading}
                />
                <button
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full relative overflow-hidden bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 disabled:from-gray-600 disabled:to-gray-700 text-white p-4 rounded-2xl font-semibold transition-all duration-300 transform hover:scale-[1.02] hover:shadow-2xl active:scale-[0.98] group"
              >
            ...
            <div className="mt-6 text-center">
              <p className="text-white/70 text-lg">
                ...
                <Link 
                  to="/login" 
                  className="text-transparent bg-gradient-to-r from-purple-400 to-blue-400 bg-clip-text font-semibold hover:from-purple-300 hover:to-blue-300 transition-all duration-300 relative group"
                >
                  Sign In
